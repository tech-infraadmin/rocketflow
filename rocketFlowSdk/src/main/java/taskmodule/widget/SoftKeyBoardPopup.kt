...
import taskmodule.R
import taskmodule.data.model.DocumentType
...
class SoftKeyBoardPopup(
    ...
    private var listener:DocumentsSelectListener? = null
    init {
        listener=context as DocumentsSelectListener
        initConfig()
    ...
    private fun initMenuView() {
        view = LayoutInflater
            .from(context)
            .inflate(R.layout.menu_soft_keyboard_sdk, rootView, false)
...
//    }
    interface DocumentsSelectListener {
