package taskmodule.data.model.response.config
...
import taskmodule.data.model.NotificationResponse
...
import taskmodule.data.model.request.Shift
import taskmodule.ui.custom.GlideApp
import taskmodule.ui.products.PackInfo
import taskmodule.ui.taskdetails.StageHistoryData
...
class StatusLocation(
    var capturedAt: Double? = 0.00,
    var geoCoordinates: StatusCoordinates,
...
enum class TRAGETINFO {
    TAG_INVENTORY, CREATE_TASK, NONE, ASSIGN_EXECUTIVE, UNIT_INFO, PAYMENT, BOOK_SLOT
}
