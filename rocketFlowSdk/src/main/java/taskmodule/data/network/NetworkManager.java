...
public interface NetworkManager {
    ...
    void uploadSkuInfoData(ApiCallback apiCallback, SKUInfoSpecsRequest data, HttpManager httpManager, Api api);
    ...
    void sendCtaOtp(ApiCallback apiCallback, HttpManager httpManager, SendCtaOtpRequest sendCtaOtpRequest, Api api);
