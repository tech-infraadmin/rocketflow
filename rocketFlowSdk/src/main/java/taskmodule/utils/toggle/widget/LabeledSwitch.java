...
package taskmodule.utils.toggle.widget;
...
//      Drawing Switch background here
        {
            ...
            if(isEnabled()) {
                onColor = Color.argb(alpha, Color.red(colorBorder), Color.green(colorBorder), Color.blue(colorBorder));
...
//      Drawing Switch Labels here
        ...
        if(isOn) {
            ...
            alpha = (alpha < 0 ? 0 : (alpha > 255 ? 255 : alpha));
            int onColor = Color.argb(alpha, Color.red(colorDisabled), Color.green(colorDisabled), Color.blue(colorDisabled));
            paint.setColor(onColor);
            ...
            alpha = (alpha < 0 ? 0 : (alpha > 255 ? 255 : alpha));
            int offColor = Color.argb(alpha, Color.red(Color.WHITE), Color.green(Color.WHITE), Color.blue(Color.WHITE));
            paint.setColor(offColor);
            ...
            int onColor;
            if(isEnabled()) {
                onColor = Color.argb(alpha, Color.red(Color.parseColor("#828282")), Color.green(Color.parseColor("#828282")), Color.blue(Color.parseColor("#828282")));
            } else {
                onColor = Color.argb(alpha, Color.red(Color.WHITE), Color.green(Color.WHITE), Color.blue(Color.WHITE));
            }
            paint.setColor(onColor);
...
//      Drawing Switch Thumb here
        {
            ...
            int offColor=0;
            if(isOn)
             offColor = Color.argb(alpha, Color.red(colorDisabled), Color.green(colorDisabled), Color.blue(colorDisabled));
            else{
                offColor = Color.argb(alpha, Color.red(colorOff), Color.green(colorOff), Color.blue(colorOff));
            }
            paint.setColor(offColor);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        thumbRadii = (int) (Math.min(width, height) / (2.3f));
