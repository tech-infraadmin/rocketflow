...
import taskmodule.data.model.response.config.Event
import taskmodule.data.model.response.config.Location
...
class TaskDetailViewModel(dataManager: DataManager, schedulerProvider: SchedulerProvider) :
        BaseSdkViewModel<TaskDetailNavigator>(dataManager, schedulerProvider), ApiCallback,
        LocationObserver {
