...
import taskmodule.data.model.request.QrCodeRequest
...
import taskmodule.ui.taskdetails.subtask.SubTaskFragment
import taskmodule.ui.taskdetails.timeline.TaskDetailsFragment
...
import taskmodule.databinding.ActivityNewTaskDetailsSdkBinding
...
//    }
    ...
    private fun openQrCode() {
        ...
        dialog.window!!.setBackgroundDrawable(
                ColorDrawable(
                        Color.TRANSPARENT))
        dialog.setContentView(R.layout.item_show_qr_code_sdk)
