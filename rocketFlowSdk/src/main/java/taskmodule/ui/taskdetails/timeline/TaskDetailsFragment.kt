...
import taskmodule.databinding.LayoutFrgmrntTaskDetailsSdkBinding
import taskmodule.ordercode.OrderCodeActivity
import taskmodule.ui.base.BaseSdkFragment
//import taskmodule.ui.chat.ChatActivity
...
import taskmodule.ui.custom.socket.*
import taskmodule.ui.dynamicform.DynamicFormActivity
import taskmodule.ui.dynamicform.DynamicFormActivity.Companion.newIntent
...
import taskmodule.ui.taskdetails.*
import taskmodule.ui.taskdetails.timeline.skuinfo.SkuInfoActivity
import taskmodule.ui.taskdetails.timeline.skuinfopreview.SkuInfoPreviewActivity
import taskmodule.ui.tasklisting.TaskClickListener
import taskmodule.ui.tasklisting.assignedtome.TaskAssignToMeViewModel
import taskmodule.ui.userlisting.UserListNewActivity
import taskmodule.ui.webview.PaymentViewActivity
import taskmodule.ui.webview.WebViewActivity
import taskmodule.utils.*
import taskmodule.utils.AppConstants.Extra
import taskmodule.utils.geofence.AddGeoFenceUtil
//import taskmodule.utils.geofence.AddGeoFenceUtil
...
import taskmodule.ui.dynamicform.dynamicfragment.*
...
//                        ivCurrentStageLocation.visibility = View.GONE
    ...
    override fun handleGetTaskDataResponse(callback: ApiCallback, result: Any?, error: APIError?) {
        ...
        if (CommonUtils.handleResponse(callback, error, result, context)) {
            ...
            var data: List<taskmodule.data.model.response.config.TaskData>? = null
            if (getTaskDataResponse != null && getTaskDataResponse.successful) {
                ...
                if (getTaskDataResponse.data != null) {
                    ...
                    getTaskDataResponse.data!!.let {
                        var list1 = ArrayList<taskmodule.data.model.response.config.TaskData>()
                        list1.addAll(it as ArrayList<taskmodule.data.model.response.config.TaskData>)
