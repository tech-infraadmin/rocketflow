...
import taskmodule.data.model.request.GetTaskDataRequest
...
import taskmodule.databinding.FragmentFormListSdkBinding
...
class DynamicFragment : BaseSdkFragment<FragmentFormListSdkBinding, DynamicViewModel>(),
    ...
    override fun getLayoutId(): Int {
        return R.layout.fragment_form_list_sdk
    }

    override fun getViewModel(): DynamicViewModel {
        val factory = RocketFlyer.dataManager()?.let { DynamicViewModel.Factory(it) } // Factory
        if (factory != null) {
            mDynamicViewModel = ViewModelProvider(this, factory)[DynamicViewModel::class.java]
        }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mFragmentFormListSdkBinding = viewDataBinding
    ...
    private fun setUp() {
        ...
        val rvDynamicForm = mFragmentFormListSdkBinding?.rvDynamicForms
...
//                                                }
            ...
            AUTOCOMPLETE_REQUEST_CODE -> {
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    var jsonConverter = JSONConverter<taskmodule.ui.addplace.HubLocation>()
    ...
    fun setChildVideo(pos: Int, file: File, path: String) {
        if (adapter.childDynamicAdapter != null) {
            adapter.childDynamicAdapter.ItemDynamicFormVideoSdkBinding = mBinding
