...
import taskmodule.data.model.request.Contact
...
import taskmodule.databinding.ActivityNewCreateTaskSdkBinding
...
import taskmodule.ui.newdynamicform.NewDynamicFormFragment
...
import taskmodule.ui.dynamicform.dynamicfragment.SlotAdapter
import taskmodule.ui.dynamicform.dynamicfragment.SlotChildAdapter
import java.io.File
import java.util.*
...
//        val city = spnCity.selectedItem.toString().trim()
        ...
        /* if (cardManualStartLocation.visibility == View.VISIBLE && regionId == null) {
            ...
            var source: taskmodule.data.model.response.config.Place? =
                taskmodule.data.model.response.config.Place()
            ...
            var destination: taskmodule.data.model.response.config.Place? =
                taskmodule.data.model.response.config.Place()
...
//                        start a thread other than main
    ...
    private fun perFormCreateTask() {
        ...
        if (hubIdFinal != "") {
            val destination = taskmodule.data.model.response.config.Place()
