package taskmodule.ui.geofencing;
...
import taskmodule.R;
import taskmodule.ui.geofencing.GeofenceBroadcastReceiver;
import taskmodule.ui.geofencing.GeofenceErrorMessages;
...
public class GeofenceUtil implements OnCompleteListener<Void> {
    ...
    static String TAG = GeofenceUtil.class.getName();
    /**
     * Provides access to the Geofencing API.
     */
    private GeofencingClient mGeofencingClient;
    /**
     * The hashMap of geofences used in this sample.
     */
    ...
    public GeofenceUtil(Activity activity) {
        ...
        mGeofencingClient = LocationServices.getGeofencingClient(this.activity);
    }
    ...
    private PendingIntent getGeofencePendingIntent() {
        ...
        mGeofencePendingIntent = PendingIntent.getBroadcast(activity, 0, intent, taskmodule.utils.CommonUtils.PendingIntentFlag);
        return mGeofencePendingIntent;
    }
...
//            Toast.makeText(activity, activity.getString(R.string.insufficient_permissions), Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    /**
     * Builds and returns a GeofencingRequest. Specifies the hashMap of geofences to be monitored.
