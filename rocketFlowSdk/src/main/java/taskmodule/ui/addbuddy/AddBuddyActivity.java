...
import taskmodule.databinding.ActivityAddBuddySdkBinding;
import taskmodule.ui.base.BaseSdkActivity;
import taskmodule.utils.AddContactInDataBase;
 ...
 */
public class AddBuddyActivity extends BaseSdkActivity<ActivityAddBuddySdkBinding, AddBuddyViewModel>
    ...
    private ActivityAddBuddySdkBinding mActivityAddBuddyBinding;
    ...
    public int getLayoutId() {
        return R.layout.activity_add_buddy_sdk;
    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        api = TrackiSdkApplication.getApiMap().get(ApiType.ADD_BUDDY);
