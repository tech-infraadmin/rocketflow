...
import taskmodule.data.model.request.HomeRequest;
 ...
 */
public class MainViewModel extends BaseSdkViewModel<MainNavigator> {
    ...
    private class HomeAPI implements ApiCallback {
        ...
        @Override
        public void hitApi() {
            Api api = TrackiSdkApplication.getApiMap().get(ApiType.HOME);
    ...
    private class LogoutAPI implements ApiCallback {
        private Api api = TrackiSdkApplication.getApiMap().get(ApiType.LOGOUT);
    ...
    private class GetUserLocations implements ApiCallback {
        private Api api = TrackiSdkApplication.getApiMap().get(ApiType.USER_LOCATIONS);
    ...
    class Punch implements ApiCallback {
        private Api api = TrackiSdkApplication.getApiMap().get(ApiType.PUNCH);
        Object data;
        PunchInOut event;
    ...
    class EndTask implements ApiCallback {
        ...
        @Override
        public void hitApi() {
            Api api = TrackiSdkApplication.getApiMap().get(ApiType.END_TASK);
    ...
    class MarkOnlineOffline implements ApiCallback {
        private Api api = TrackiSdkApplication.getApiMap().get(ApiType.CHANGE_STATUS);
        Object data;
