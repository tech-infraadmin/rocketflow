...
import taskmodule.data.model.request.RegionRequest
import taskmodule.data.model.request.SaveFilterData
import taskmodule.data.model.response.config.GetUserManualLocationData
import taskmodule.data.model.response.config.LocData
...
import taskmodule.databinding.ActivityTaskFilterSdkBinding
...
class TaskFilterActivity : BaseSdkActivity<ActivityTaskFilterSdkBinding, TaskFilterViewModel>(),
    ...
    private lateinit var mActivityTaskFilterBinding: ActivityTaskFilterSdkBinding
...
//            }
    ...
    override fun getLayoutId(): Int {
        return R.layout.activity_task_filter_sdk
    }
...
//                preferencesHelper.filterMap[categoryId] = saveFilterConfig
    ...
    private fun openSelectMultipleSelect(list: ArrayList<LocData>) {
        ...
        dialog.setContentView(R.layout.layout_multiselect_drop_down_sdk)
