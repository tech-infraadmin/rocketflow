...
import taskmodule.data.model.response.config.ActionConfig;
import taskmodule.data.model.response.config.AssigneeDetail;
...
import taskmodule.data.model.response.config.UserGroup;
import taskmodule.databinding.ItemIHaveAssignedEmptyViewSdkBinding;
