...
import taskmodule.databinding.ItemAssignedToMeEmptyViewSdkBinding;
import taskmodule.databinding.LayoutRowAssigndToMeSdkBinding;
import taskmodule.ui.base.BaseSdkViewHolder;
import taskmodule.ui.taskdetails.TaskDetailActivity;
import taskmodule.ui.tasklisting.TaskClickListener;
import taskmodule.ui.tasklisting.TaskComparator;
 ...
 */
public class AssignedtoMeAdapter extends RecyclerView.Adapter<BaseSdkViewHolder> {
...
//                        parent, false);
   ...
   public List<Task> getList(){
    ...
    public class AssignedtoMeViewHolder extends BaseSdkViewHolder implements TaskAssignToMeViewModel
            .AssignedtoMeItemViewModelListener {
        private LayoutRowAssigndToMeSdkBinding mBinding;

        AssignedtoMeViewHolder(LayoutRowAssigndToMeSdkBinding binding) {
