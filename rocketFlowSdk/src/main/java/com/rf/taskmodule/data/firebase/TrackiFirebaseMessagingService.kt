...
class TrackiFirebaseMessagingService : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        preferencesHelper = com.rf.taskmodule.data.local.prefs.AppPreferencesHelper(
            applicationContext,
        ...
        try {
            ...
            if (remoteMessage.data.isNotEmpty()) {
                ...
                if (remoteMessage.data.containsKey("navigation")) {
                    ...
                    var jsonConverter = com.rf.taskmodule.utils.JSONConverter<FeedsJson>()
        ...
        try {
            ...
            if (notificationModel != null) {
                ...
                if (notificationModel.event == NotificationEventStatus.PUNCH_OUT) {
                    ...
                    com.rf.taskmodule.utils.CommonUtils.handleForceActions(
                        notificationModel,
                        applicationContext,
                        preferencesHelper
                    )
