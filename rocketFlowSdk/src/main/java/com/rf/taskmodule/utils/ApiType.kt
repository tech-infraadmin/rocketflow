...
enum class ApiType {
   ...
   SEARCH_PRODUCT,APP_ERROR,GET_UNITS,SUB_CATEGORIES,TERMINAL_CATEGORIES,DAILY_STOCK_HISTORY,STOCK_HISTORY_DETAIL,GET_POST_DETAIL,
    ...
    INIT_TASK_PAYMENT,
    GET_WALLET_BALANCE,SCANNER,ENTITY_SCANNER,
    INITIATE_DEVICE_CHANGE,GET_TIME_SLOTS,SDK_LOGIN_TOKEN,SAVE_TASK_UNITS,
    TASK_UNIT_CONFIG,UNIT_INFO_LISTING,CTA_SEND_OTP,CTA_VERIFY_OTP,BOOK_TIME_SLOT,SYSTEM_HUBS,
    SEARCH_REFERENCE_ELIGIBLE_TASKS,LOGIN_USING_QR,TASK_BY_ENTITY
}