...
open class SkuInfoPreviewActivity : com.rf.taskmodule.ui.base.BaseSdkActivity<ActivitySkuInfoSdkBinding, SkuInfoPreviewViewModel>(), SkuInfoPreviewNavigator,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent.hasExtra(com.rf.taskmodule.utils.AppConstants.Extra.EXTRA_PRODUCT_ID)) {
            prodId = intent.getStringExtra(com.rf.taskmodule.utils.AppConstants.Extra.EXTRA_PRODUCT_ID)!!
            com.rf.taskmodule.utils.CommonUtils.showLogMessage("d", "prodId", prodId)
        }
        if (intent.hasExtra(com.rf.taskmodule.utils.AppConstants.Extra.EXTRA_PRODUCT_NAME)) {
            prodName = intent.getStringExtra(com.rf.taskmodule.utils.AppConstants.Extra.EXTRA_PRODUCT_NAME)!!
            com.rf.taskmodule.utils.CommonUtils.showLogMessage("d", "prodName", prodName)
            ...
            when (message.what) {
                ...
                if (count == 0) {
                    runOnUiThread {
                        ...
                        com.rf.taskmodule.utils.CommonUtils.makeScreenClickable(this@SkuInfoPreviewActivity)
                    }
                    count++
                    fileUploadCounter = 0
                    TrackiToast.Message.showShort(this@SkuInfoPreviewActivity,
