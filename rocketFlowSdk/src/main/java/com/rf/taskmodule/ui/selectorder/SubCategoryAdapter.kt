...
import com.rf.taskmodule.databinding.ItemRowSubCategorySdkBinding
...
class SubCategoryAdapter (var context: Context) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SubCategoryItemViewHolder {
        ...
        val simpleViewItemBinding: ItemRowSubCategorySdkBinding =
            ItemRowSubCategorySdkBinding.inflate(
