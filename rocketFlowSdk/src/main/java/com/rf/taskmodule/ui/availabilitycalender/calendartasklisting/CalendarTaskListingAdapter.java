...
import com.rf.taskmodule.ui.tasklisting.AssignTaskViewModel;
...
public class CalendarTaskListingAdapter extends RecyclerView.Adapter<BaseSdkViewHolder> {
    ...
    public CalendarTaskListingAdapter(List<Task> responseList, PreferencesHelper preferencesHelper) {
