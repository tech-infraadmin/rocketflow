...
enum class ApiType {
   ...
   SEARCH_PRODUCT,APP_ERROR,GET_UNITS,SUB_CATEGORIES,TERMINAL_CATEGORIES,DAILY_STOCK_HISTORY,STOCK_HISTORY_DETAIL,GET_POST_DETAIL,
    ...
    UPDATE_DOCUMENT,
    ASSIGNMENT_ELIGIBLE_USERS,
    INIT_TASK_PAYMENT,
    GET_WALLET_BALANCE,SCANNER,ENTITY_SCANNER,INITIATE_DEVICE_CHANGE,GET_TIME_SLOTS,SDK_LOGIN_TOKEN,SAVE_TASK_UNITS,TASK_UNIT_CONFIG,UNIT_INFO_LISTING
