...
class SkuInfoViewModel(dataManager: DataManager, schedulerProvider: SchedulerProvider) :
    BaseViewModel<SkuInfoNavigator>(dataManager, schedulerProvider) {
    ...
    private inner class GetTaskData(var taskId:String?) : ApiCallback {
        ...
        override fun hitApi() {
            if(TrackiApplication.getApiMap().containsKey(ApiType.TASK_UNIT_CONFIG)) {
                val api = TrackiApplication.getApiMap()[ApiType.TASK_UNIT_CONFIG]
                val apiUrl = Api()
    ...
    internal class Factory(private val mDataManager: DataManager) : ViewModelProvider.Factory {
        override fun <T : ViewModel> create(modelClass: Class<T>): T {
            return SkuInfoViewModel(mDataManager, AppSchedulerProvider()) as T
        }
    }
