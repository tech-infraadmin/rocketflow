...
import com.tracki.data.local.db.GeofenceDataSource;
...
public class GeofenceTransitionsJobIntentService extends JobIntentService {
    ...
    private void sendNotification(String notificationDetails) {
        ...
        // Create an explicit content Intent that starts the splash Activity.
...
//            bigTextStyle.setBigContentTitle(title)
        ...
        builder.setSmallIcon(R.drawable.ic_notification/*R.drawable.ic_launcher*/)
                // In a real app, you may want to use a library like Volley
                // to decode the Bitmap.
                .setLargeIcon(BitmapFactory.decodeResource(getResources(),
                        R.drawable.ic_notification/*R.drawable.ic_launcher*/))
